...
import { teamsFetchSucceeded } from '../actions';
...
describe('teamsReducer', () => {
  ...
  it('returns the initial state', () => {
    expect(teamsReducer(undefined, {})).toEqual(state);
  });

  it('should handle the teamsFetchSucceeded action correctly', () => {
    const expectedResult = state.set('teams', teams);
    expect(teamsReducer(state, teamsFetchSucceeded(teams))).toEqual(expectedResult);
  });
});
